...
public class ColorPickerPopup {
    ...
    public void show(View parent, final ColorPickerObserver observer) {
        ...
        View layout = inflater.inflate(com.example.mobildonemprojesi.R.layout.color_picker_popup, null);
        final ColorPickerView colorPickerView = layout.findViewById(com.example.mobildonemprojesi.R.id.colorPickerView);
        ...
        TextView cancel = layout.findViewById(com.example.mobildonemprojesi.R.id.cancel);
        ...
        TextView ok = layout.findViewById(com.example.mobildonemprojesi.R.id.ok);
        ok.setText(okTitle);
        ...
        final View colorIndicator = layout.findViewById(com.example.mobildonemprojesi.R.id.colorIndicator);
        final TextView colorHex = layout.findViewById(com.example.mobildonemprojesi.R.id.colorHex);
        ...
        popupWindow.setAnimationStyle(com.example.mobildonemprojesi.R.style.TopDefaultsViewColorPickerPopupAnimation);
