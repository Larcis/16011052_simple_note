...
public class ColorPickerView extends LinearLayout implements ColorObservable {
    ...
    public ColorPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.example.mobildonemprojesi.R.styleable.ColorPickerView);
        boolean enableAlpha = typedArray.getBoolean(com.example.mobildonemprojesi.R.styleable.ColorPickerView_enableAlpha, false);
        boolean enableBrightness = typedArray.getBoolean(com.example.mobildonemprojesi.R.styleable.ColorPickerView_enableBrightness, true);
        onlyUpdateOnTouchEventUp = typedArray.getBoolean(com.example.mobildonemprojesi.R.styleable.ColorPickerView_onlyUpdateOnTouchEventUp, false);
        typedArray.recycle();
