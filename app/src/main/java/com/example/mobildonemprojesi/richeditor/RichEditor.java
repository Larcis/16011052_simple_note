package com.example.mobildonemprojesi.richeditor;
...
public class RichEditor extends WebView {
  ...
  public void insertAddress(String address, int color) {
    //exec("javascript:RE.prepareInsert();");
    String col ="#"+ Integer.toHexString(color & 0x00ffffff);
    exec("javascript:RE.insertAddress('" + address +"','" +col+ "');");
  }
